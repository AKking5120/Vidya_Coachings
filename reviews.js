...
const REVIEWS_CONFIG = {
    API_URL: 'https://script.google.com/macros/s/AKfycbwmWQ5d_Jyr-WT1eQAEFtXoHBX6AFDrnUGjuBpC21xJrMxlMhpyhC2U4gmhLUQ8nW1jDQ/exec'
};
...
(function () {
    ...
    async function submitReview(e) {
        ...
        const payload = JSON.stringify({ name, role, rating, text, ip });
